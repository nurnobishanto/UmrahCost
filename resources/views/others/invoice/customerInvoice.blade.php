            ...
            <div class="inv-summary">
                ...
                <div class="content">
                    ...
                    @foreach ($customPackage->packageHotels as $key => $packageHotel)
                        ...
                        @endphp
                        <p><span>{{ $packageHotel?->location?->name }} Hotel</span><span>- {{ $packageHotel?->hotel?->name }}</span><span></span></p>
                        <p><span></span><span>
                    ...
                    <p><span>Visa Fee</span><span>- </span><span></span></p>
                    <p><span>Air Ticket</span><span>- {{ $customPackage?->airline?->name }}</span><span></span></p>
                    <p><span>Transport</span><span>- {{ $customPackage?->transport?->name }}</span><span></span></p>

                    @foreach ($customPackage->packageGuides as $key => $packageGuide)
                        <p><span>Guide </span><span>- {{ $packageGuide?->guide?->name }}</span><span></span></p>
                    @endforeach

                    @foreach ($customPackage->packageHotels as $key => $packageHotel)
                        <p><span>Sightseeing ({{ $packageHotel?->location?->name }})</span><span>- {{ $packageHotel?->sightseeing?->name }}</span><span></span></p>
                    @endforeach


                    <p><span>Food</span><span>- </span><span></span></p>
                    @php
