                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <fieldset class="ams-input">
                                                ...
                                                <input type="text" name="group_no" value="{{ old('group_no',$serviceVoucher->group_no) }}" placeholder="Enter group no"
                                        ...
                                        <div class="col-6">
                                            <fieldset class="ams-input">
                                                ...
                                                <input type="text" name="serial_no" value="{{ old('serial_no',$serviceVoucher->serial_no) }}" placeholder="Enter Serial no"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <fieldset class="ams-input">
                                        ...
                                        <textarea name="office_address" id="office_address" cols="30" class="ckeditor" rows="2">{!! old('office_address', $serviceVoucher->office_address) !!}</textarea>
