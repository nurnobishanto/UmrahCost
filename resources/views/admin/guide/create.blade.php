    ...
    <div class="ams-panel-wpr panel-md">
        <div class="ams-panel">
            <div class="panel-heading">
                <h5 class="panel-title">Add Guide</h5>
                <div>
            ...
            <div class="panel-body">
                <div class="ams-customer-add-form">
                    <form method="POST" action="{{ route('admin.guide.store') }}" enctype="multipart/form-data" class="ams-form">
                        @csrf
                        ...
                        <fieldset class="ams-input input-verticle">
                            ...
                            <input type="number" step="any" value="{{ old('cost') }}" name="cost" id="cost" placeholder="Enter Cost">
                            @error('cost')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </fieldset>
