...
@endpush
@section('content')
    <!-- Client Feedback Datatable -->
    <div class="ams-panel-wpr">
        <div class="ams-panel">
            <div class="panel-heading">
                <h5 class="panel-title">Client Feedback List</h5>
                @if (check_permission('Client Feedback Create'))
                    <a href="{{ route('admin.clientFeedback.create') }}" class="panel-item">+ Add Client Feedback</a>
                @endif
            </div>
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                "pageLength": 10,
                ajax: '{!! route('admin.clientFeedback.index') !!}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
