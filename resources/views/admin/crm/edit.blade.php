    ...
    <div class="ams-panel-wpr panel-md">
        <div class="ams-panel">
            <div class="panel-heading">
                <h5 class="panel-title">Edit CRM</h5>
                <div>
            ...
            <div class="panel-body">
                <div class="ams-customer-add-form">
                    <form method="POST" action="{{ route('admin.crm.update', $user->id) }}" enctype="multipart/form-data" class="ams-form">
                        @csrf
                        @method('PUT')
                        ...
                        <fieldset class="ams-input input-verticle">
                            ...
                            <input type="email" value="{{ $user->email }}" name="email" id="email" placeholder="Enter Email">
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </fieldset>
                        <fieldset class="ams-input input-verticle">
                            ...
                            <input type="number" value="{{ $user->phone }}" name="phone" id="phone" placeholder="Enter Phone">
                            @error('phone')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </fieldset>
                        ...
                        <fieldset class="ams-input input-verticle">
                            <img src="{{ asset($user->avatar ?? 'assets/no_image.jpg') }}" id="avatar_review"
