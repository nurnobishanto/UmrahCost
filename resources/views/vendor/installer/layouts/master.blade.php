            ...
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('LaravelInstaller::verify') }}">
                        @if(Request::is('install') || Request::is('install/verify') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
