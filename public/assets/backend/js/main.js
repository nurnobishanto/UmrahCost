...
(function($){
    ...
    $(function() {
        // let autoUpdate = $('input[name="datetimes"]').data("show");
...
(function(){
    ...
    $(document).ready(function() {
        ...
        $(".doc-upload-path").on("click",function(){
            $(".doc-file-upload").click();
        })

        $('.doc-file-upload').change(function() {
            $('.doc-upload-path').val($('.doc-file-upload')[0].files.length+" Documents");
        });
